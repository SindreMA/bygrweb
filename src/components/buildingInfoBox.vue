    ...
    <div>
        ...
        <div id="Container" class="topMargin shadow-1 flex" >
            ...
            <div class="flexNoGrow" v-for="(buyer, index) in data.buyers" :key="buyer.key">
                ...
                <div>Invited: xx.xx.xxxx <q-tooltip>JSON filen manglet denne informasjonen</q-tooltip></div>
            </div>
            <div class="flexNoGrow">
...
export default {
    ...
    computed : {
        lastLoginBuyer() {
            return _.sortBy(this.data.buyers, x=> {return moment(x.lastVisitDate).unix()}).reverse()[0]
        }
    },
    components: {
        statusLine
